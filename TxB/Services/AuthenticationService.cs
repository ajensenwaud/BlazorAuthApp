...
public class AuthenticationService
{
    ...
    public async Task<(AuthenticationResult, SignInResult?, ApplicationUser?)> LoginAsync(string email,
    ...
    public async Task<(ApplicationUser, IdentityResult)> CreateUserAsync(RegisterFormModel rfm, bool makeAdmin, bool emailConfirmed, bool sendEmail)
    {
    ...
    public ApplicationUser FindByActivationId(string activationId)
    {
        var u = _identityContext.Users.First(u => u.ActivationKey == activationId);
        return u;
    }

    public ApplicationUser GetById(Guid key)
    {
    ...
    public void ActivateUser(ApplicationUser u)
    {
    ...
    public ApplicationUser? FindByResetId(string resetKey)
    {
    ...
    public string SetPasswordResetKey(ApplicationUser u)
    {
        var user = GetById(u.Id);
