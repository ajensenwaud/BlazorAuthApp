...
Someone (possibly you) has requested to reset the password for your FinTech Proposition Generator account. Follow the link below to reset your password:<br /><br />
...
";
    ...
    public async Task<Response>  SendActivationEmail(string emailTo, string nameTo, string baseUrl, string activationKey)
    {
        ...
        var plainWelcome = $@"Dear {nameTo},
Welcome to FinTech Proposition Generator!
...
The FinTech Proposition Generator Crew";
        ...
        var htmlWelcome = $@"Dear {nameTo},<br />
Welcome to FinTech Proposition Generator!<br />
...
The FinTech Proposition Generator Crew";
        ...
        var subj = "FinTech Proposition Generator - account activation link";
